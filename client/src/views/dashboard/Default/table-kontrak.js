...
const columns = [
  ...
  },
  {
    ...
    width: 80,
    getActions: (params) => [
      <GridActionsCellItem icon={<FileCopyIcon />} label="Perpanjang" showInMenu />,
      <GridActionsCellItem icon={<SecurityIcon />} label="Resign" showInMenu />,
...
const rows = [
  {
    id: '001',
    lastName: 'Snow',
    firstName: 'Software Enggineer',
    age: 'Bandung',
    habiskontrak: '01-12-2014',
    mulaikontrak: '01-12-2014'
  },
  {
    id: '002',
    lastName: 'Lannister',
