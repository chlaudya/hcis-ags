...
const columns = [
    ...
    { field: 'is_active', headerName: 'Aktif', width: 180 },
    {
        ...
        renderCell: (cellValues) => {
            return (
                <>
                    <IconButton color="secondary" aria-label="add an alarm" onClick={() => console.log('edit')}>
                        <Edit style={{ color: blue[900] }} />
                    </IconButton>
                    <IconButton color="warning" aria-label="add an alarm" onClick={() => console.log('delete')}>
        ...
        <MainCard title="Data Jabatan">
            <Typography variant="body2">
                ...
                <div style={{ height: 500, width: '100%' }}>
                    <DataGrid rows={rows} columns={ColumnsJabatan({ handleEdit, handleDelete })} pageSize={5} rowsPerPageOptions={[5]} />
                </div>
            </Typography>
        </MainCard>
    );
